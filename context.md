...
- UI: Simple/Advanced via `localStorage.uiMode` + `data-mode` (theme-init pre-paint).
  ...
  Teal Soft tokens: accent `#0f766e`, 8/12/18px radii, Fraunces + Public Sans
  (self-hosted), cool paper / near-black dark, score ring on Search.
...
- **Done:** 5.0.4 — extra admin/helpdesk tools, tickets, incident banner,
  Ship `/ops`, Teal Soft (Fraunces + Public Sans self-hosted).
